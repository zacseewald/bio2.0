    ...
    return (
      <div id="card-style">
        ...
        <div className="wrapper">
            ...
            <h5>Discription:</h5>
            <p id="info">This site is designed to showcase my portfolio of photography work. I designed it so the user can move through the site very quickly and efficiently. It is all about the imagery and branding recognition. The audience has very little patients for unnecessary UX, they are interested in seeing the work and making a quick decision as to wether or my work alines with their needs.</p>
        </div>
